...
import com.example.weatherapp2.Models.WeatherModel
import com.example.weatherapp2.Utilites.ApiUtilites
...
class MainActivity : AppCompatActivity() {
    ...
    private fun getCityWeather(city: String) {
        ...
        ApiUtilites.getApiInterface()?.getCityWeatherData(city,apiKey)
    ...
    private fun fetchCurrentLocationWeather(latitude: String, longitude: String) {
        ...
        ApiUtilites.getApiInterface()?.getCurrentWeatherData(latitude,longitude,apiKey)
            ?.enqueue(object :Callback<WeatherModel>{
                @RequiresApi(Build.VERSION_CODES.O)
                override fun onResponse(call: Call<WeatherModel>, response: Response<WeatherModel>) {
            ...
            when (id) {
                ...
                in 200..232 -> {
                    ...
                    mainLayout.background=ContextCompat
                        .getDrawable(this@MainActivity, R.drawable.thunderstorm_bg)
